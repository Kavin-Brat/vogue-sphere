...
const TopMenubar: React.FC = () => {
  ...
  return (
    <div className="flex flex-row justify-center items-center w-full h-[50px] xl:h-[60px] 2xl:h-[90px] py-[10px] xl:py-[14px] 2xl:py-[10px] px-[12px] xl:px-[20px] 2xl:px-[30px] border-b border-[#EDEDED]">
      ...
      <div className="basis-24 lg:basis-1/2 grid justify-items-center">
        <SearchDropdown />
      </div>
      <div className="basis-32 lg:basis-1/4 flex justify-between cursor-pointer">
        <div className="basis-32 lg:basis-1/2 flex space-x-2 2xl:space-x-3 flex justify-center items-center">
          <div className="">
          ...
          <a href={`/shop/login`} className="text-xs font-normal text-[#666666] block lg:hidden">
            Sign in
          </a>
        </div>
        <div className="basis-32 lg:basis-1/2 flex justify-end space-x-2 2xl:space-x-3 cursor-pointer">
